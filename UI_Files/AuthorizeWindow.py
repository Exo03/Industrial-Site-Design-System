...
class Ui_AuthorizeWindow(object):
    def setupUi(self, AuthorizeWindow):
        ...
        AuthorizeWindow.resize(529, 344)
...
"}")
        ...
        self.authLabel.setGeometry(QRect(190, 20, 138, 35))
        self.authLabel.setStyleSheet(u"font-size: 20px;")
        self.layoutWidget = QWidget(AuthorizeWindow)
        self.layoutWidget.setObjectName(u"layoutWidget2")
        self.layoutWidget.setGeometry(QRect(101, 71, 301, 150))
        self.paslogLayout = QVBoxLayout(self.layoutWidget)
        self.paslogLayout.setSpacing(10)
        self.paslogLayout.setObjectName(u"paslogLayout")
        self.paslogLayout.setContentsMargins(0, 0, 0, 0)
        self.logLayout = QVBoxLayout()
        self.logLayout.setSpacing(0)
        self.logLayout.setObjectName(u"logLayout")
        self.loginLabel = QLabel(self.layoutWidget)
        self.loginLabel.setObjectName(u"loginLabel")
        self.loginLabel.setLayoutDirection(Qt.LeftToRight)
        self.loginLabel.setLineWidth(0)
        self.loginLabel.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.passwordLabel.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.forgotPasswordLink = QLabel(self.layoutWidget)
        ...
        self.layoutWidget1 = QWidget(AuthorizeWindow)
        self.layoutWidget1.setObjectName(u"layoutWidget1")
        self.layoutWidget1.setGeometry(QRect(200, 230, 101, 84))
        self.enterLayout = QVBoxLayout(self.layoutWidget1)
        self.enterLayout.setSpacing(0)
        self.enterLayout.setObjectName(u"enterLayout")
        self.enterLayout.setContentsMargins(0, 0, 0, 0)
        ...
        self.registerLink = QLabel(self.layoutWidget1)
        self.registerLink.setObjectName(u"registerLink")
        self.registerLink.setAlignment(Qt.AlignCenter)
