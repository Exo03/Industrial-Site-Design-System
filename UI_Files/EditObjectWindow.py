...
"    }")
        ...
        self.zoneLabel = QLabel(Object_edit)
        self.zoneLabel.setObjectName(u"zoneLabel")

        self.verticalLayout.addWidget(self.zoneLabel)

        self.zoneLineEdit = QLineEdit(Object_edit)
        self.zoneLineEdit.setObjectName(u"zoneLineEdit")

        self.verticalLayout.addWidget(self.zoneLineEdit)
    ...
    def retranslateUi(self, Object_edit):
        ...
        self.TextLabel.setText(QCoreApplication.translate("Object_edit", u"\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u043e\u0431\u044a\u0435\u043a\u0442\u0430:  ", None))
        ...
        self.zoneLabel.setText(QCoreApplication.translate("Object_edit", u"\u0420\u0430\u0437\u043c\u0435\u0440 \u0437\u043e\u043d\u044b \u043e\u0431\u0441\u043b\u0443\u0436\u0438\u0432\u0430\u043d\u0438\u044f:", None))
